...
// myFirstPod
#define COCOAPODS_POD_AVAILABLE_myFirstPod
#define COCOAPODS_VERSION_MAJOR_myFirstPod 0
#define COCOAPODS_VERSION_MINOR_myFirstPod 1
#define COCOAPODS_VERSION_PATCH_myFirstPod 0
